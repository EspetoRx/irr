		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<img class="img-fluid rounded" src="{{$armazenamento->url('categorias/'.$categoria_esc->image)}}" style="margin-top: -60px;">

					<h1 class="text-center" style="font-size: 100px; color:white; margin-top: -160px;"><i class="fa fa-gem"></i> {{$categoria_esc->name}}</h1>
					<br>
					<br>
					<hr>
